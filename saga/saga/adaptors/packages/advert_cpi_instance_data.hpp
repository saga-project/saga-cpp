...
#ifndef SAGA_SAGA_ADAPTORS_ADVERT_CPI_INSTANCE_DATA_HPP
#define SAGA_SAGA_ADAPTORS_ADVERT_CPI_INSTANCE_DATA_HPP
...
namespace saga { namespace adaptors { namespace v1_0 
{
    ...
    //  data for an adaptor.
    struct advert_cpi_instance_data 
        : public namespace_entry_cpi_instance_data
    {
        advert_cpi_instance_data (saga::url location, int mode)
...
#endif // SAGA_SAGA_ADAPTORS_ADVERT_CPI_INSTANCE_DATA_HPP
