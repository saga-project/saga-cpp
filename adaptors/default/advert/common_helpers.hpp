...
///////////////////////////////////////////////////////////////////////////////
namespace advert { namespace detail
{
    ///////////////////////////////////////////////////////////////////////////
    ...
    // try to find database_connection back end
        ...
        saga::ini::ini prefs = ini.get_section ("preferences");
            ...
            {
                SAGA_OSSTREAM strm;
                strm << "advert::detail::get_db_type: "
    ...
    // make sure a dbname is given
        if (!dbname.empty())
            ...
            connectstr.set_value("dbname", "advertdb");

        return connectstr.get();
    }
#endif // SAGA_DEFAULT_ADVERT_ADAPTOR_USE_POSTGRESQL
        ...
        saga::impl::proxy* p)
    {
        ...
        // advert://host/path?dbtype=sqlite3&dbname=sqlite3.db
...
#if defined(SAGA_DEFAULT_ADVERT_ADAPTOR_USE_SQLITE3)
        case database_connection::db_sqlite:
            return construct_sqlite3_connect("advert.db", dbname);
#endif
#if defined(SAGA_DEFAULT_ADVERT_ADAPTOR_USE_POSTGRESQL)
        case database_connection::db_postgresql:
            return construct_pg_connect<InstanceData>("dbname=advertdb", s, p, dbname);
#endif
#if defined(SAGA_DEFAULT_ADVERT_ADAPTOR_USE_MYSQL)
        case database_connection::db_mysql:
            return construct_mysql_connect<InstanceData>("dbname=advertdb", s, p, dbname);
#endif
    ...
    // throw error 
        SAGA_OSSTREAM strm;
        strm << "advert::detail::get_db_connectstring: "
                "no database_connection dbtype specified in configuration.";
        SAGA_ADAPTOR_THROW_NO_CONTEXT(SAGA_OSSTREAM_GETSTRING(strm), 
            saga::BadParameter);
...
///////////////////////////////////////////////////////////////////////////////
}}  // namespace advert::detail

#endif // !ADAPTORS_DEFAULT_ADVERT_COMMON_HELPERS_HPP
