...
#if !defined(SAGA_IMPL_PACKAGES_JOB_JOB_SERIALIZATION_HPP)
#define SAGA_IMPL_PACKAGES_JOB_JOB_SERIALIZATION_HPP
...
// serialization support for the job package
class job_serialization
...
#endif // !SAGA_IMPL_PACKAGES_JOB_JOB_SERIALIZATION_HPP
