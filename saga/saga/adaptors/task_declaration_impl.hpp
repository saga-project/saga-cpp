...
#if !defined(SAGA_ADAPTOR_TASK_IMPL_V1_HPP)
#define SAGA_ADAPTOR_TASK_IMPL_V1_HPP
...
#define BOOST_PP_ITERATION_PARAMS_1                                           \
    ...
    "saga/saga/adaptors/task_declaration_impl.hpp"))                          \
    /**/

#include BOOST_PP_ITERATE()

#endif // SAGA_ADAPTOR_TASK_IMPL_V1_HPP
...
#define GET_TEMP_ARG(z, M, _) BOOST_PP_COMMA_IF(M) FuncArg ## M, Arg ## M
    ...
    >
    static saga::impl::task<
        Cpi, Base, RetVal, BOOST_PP_REPEAT(P, GET_TEMP_ARG, _)>*
    create_task(char const *func_name, TR1::shared_ptr<Cpi> cpi, impl::proxy* prxy, 
...
#undef GET_TEMP_ARG
    ...
    task (char const *func_name, TR1::shared_ptr<Cpi> cpi, impl::proxy* prxy,
            void (Base::*sync)(RetVal&, BOOST_PP_ENUM_PARAMS (P, FuncArg)),
            BOOST_PP_ENUM_BINARY_PARAMS (P, Arg, const& arg),
            bool (Base::*prep)(RetVal&, BOOST_PP_ENUM_PARAMS(P, FuncArg), saga::uuid) = NULL);
