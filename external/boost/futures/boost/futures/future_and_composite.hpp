...
#ifndef BOOST_FUTURE_AND_COMPOSITE_HPP
#define BOOST_FUTURE_AND_COMPOSITE_HPP 1
...
#include <boost/futures/detail/threaded_and_evaluator.hpp>
...
namespace boost {  namespace futures { 
  ...
  inline typename
      lazy_enable_if<
          ...
          >,
          as_composite<and_op, F1, F2>
      >::type
  operator&& (F1 const& f1, F2 const& f2)
  {
      return compose<and_op>(f1, f2);
  }

///////////////////////////////////////////////////////////////////////////////
}}  // namespace boost::futures

#endif /* BOOST_FUTURE_AND_COMPOSITE_HPP */
