...
#if !defined(SAGA_IMPL_PACKAGES_DATA_NAME_SPACE_NAME_SPACE_SERIALIZATION_HPP)
#define SAGA_IMPL_PACKAGES_DATA_NAME_SPACE_NAME_SPACE_SERIALIZATION_HPP
...
class namespace_serialization
:   public saga::adaptors::serialization
{
public:
    ~namespace_serialization();
...
#endif // !SAGA_IMPL_PACKAGES_DATA_NAME_SPACE_NAME_SPACE_SERIALIZATION_HPP
