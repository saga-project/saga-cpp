...
static const char* rcsid = "@(#)$RCSfile: dh_dir.c,v $ $Revision: 1.1 $ (DOWNHILL) $Date: 2006/02/07 17:25:06 $";
#endif
...
struct dirent* readdir(DIR* dir_Info)
{
	...
	dir_Info->dir_FileUnix.d_namlen = (unsigned short)strlen(dir_FileWin.cFileName);
