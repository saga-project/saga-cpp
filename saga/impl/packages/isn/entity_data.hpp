...
#ifndef SAGA_IMPL_PACKAGES_ISN_ENTITY_DATA_HPP
#define SAGA_IMPL_PACKAGES_ISN_ENTITY_DATA_HPP
...
namespace saga
{
  namespace impl
  {
        ...
        public saga::impl::attribute
    {
      ...
      explicit entity_data(attribute const& attr);
      public:

      /**
       * Constructor of entity_data
       */
      entity_data ();
      ~entity_data ();
...
#endif // !defined(SAGA_IMPL_PACKAGES_ISN_ENTITY_DATA_HPP)
