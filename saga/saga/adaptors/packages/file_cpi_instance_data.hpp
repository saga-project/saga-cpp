...
#ifndef SAGA_SAGA_ADAPTORS_FILE_CPI_INSTANCE_DATA_HPP
#define SAGA_SAGA_ADAPTORS_FILE_CPI_INSTANCE_DATA_HPP
...
namespace saga { namespace adaptors { namespace v1_0 
{
  ...
  //  data for an adaptor.
  struct file_cpi_instance_data 
      : public namespace_entry_cpi_instance_data
  {
    saga::off_t pointer_;  // current file pointer position

    file_cpi_instance_data (std::string location, int mode, 
...
#endif // SAGA_SAGA_ADAPTORS_FILE_CPI_INSTANCE_DATA_HPP
