...
#ifndef SAGA_SAGA_ADAPTORS_CPR_DIRECTORY_CPI_INSTANCE_DATA_HPP
#define SAGA_SAGA_ADAPTORS_CPR_DIRECTORY_CPI_INSTANCE_DATA_HPP
...
namespace saga { namespace adaptors { namespace v1_0 
  {
    ...
    //  data for an adaptor.
    struct cpr_directory_cpi_instance_data 
      : public namespace_dir_cpi_instance_data
    {
      cpr_directory_cpi_instance_data (saga::url location, int mode)
...
#endif // SAGA_SAGA_ADAPTORS_CPR_DIRECTORY_CPI_INSTANCE_DATA_HPP
